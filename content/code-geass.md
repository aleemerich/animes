...
titulo_original: "コードギアス 反逆のルルーシュ (Kōdo Giasu: Hangyaku no Rurūshu)"
ano: "2006"
genero:
  - Mecha
  - Ação
...
assistido: set/2017
nota_final: "9.6"
link_referencia: https://myanimelist.net/anime/1575/Code_Geass__Hangyaku_no_Lelouch
veredito_rapido: Uma obra-prima na mesma linha de Death Note. Extremamente inteligente, com críticas profundas à sociedade, à moral humana e ao existencialismo.
---

# Code Geass: Lelouch of the Rebellion

![Poster](../assets/code-geass-poster.jpg)
...
## Links e Conexões
* **Animes similares:** [Death Note](death-note.md)
* **Mesmo Estúdio/Diretor:** Estúdio [Sunrise](sunrise.md) / Diretor [Gorō Taniguchi](gorō-taniguchi.md) (Design de personagens por [CLAMP](clamp.md))
